...
import dubbsLogo from "../assets/owner/logo_nou-removebg-preview.png";
        ...
        <div className='footer-big'>
            <div className="cards" style={{ backgroundColor: "#7388E1FF", margin: 0}}>
                <div className="card-logo display-footer" style={{position: "relative", backgroundColor: "#7388E1FF"}} >
                    ...
                    <img src={dubbsLogo} className='footerLogo img-logo'  onClick={moveToTop} style={{marginRight: "10px", marginLeft: "10px", marginTop: "10px", width: "80px", height: "80px"}}/>
